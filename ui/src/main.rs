    ...
    view! {
        ...
        <SettingsView
            state=SettingsViewState {
                locale, theme_mode, light_palette, dark_palette, ui_font_size, code_font_size, selection_popup_enabled, send_with_modifier, show_settings, settings_section, open_conn_key, channels_open, connectors, model_form,
