...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "settings.provider.claude_code_desktop") => Some("Claude Code Desktop"),
        ...
        (Locale::En, "settings.claude_desktop_port") => Some("Claude Code Desktop port"),
        (Locale::En, "settings.claude_desktop_hint") => Some("Reserved for Desktop/Remote Control metadata. The runner uses the Claude command above, not a local HTTP port."),
        ...
        (Locale::Zh, "settings.provider.claude_code_desktop") => Some("Claude Code Desktop"),
        ...
        (Locale::Zh, "settings.claude_desktop_port") => Some("Claude Code Desktop 端口"),
        (Locale::Zh, "settings.claude_desktop_hint") => Some("预留给 Desktop/Remote Control 元数据。实际 runner 使用上面的 Claude 命令，不走本地 HTTP 端口。"),
