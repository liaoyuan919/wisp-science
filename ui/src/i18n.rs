...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "codex.runtime.subtitle") => Some("Models and capabilities are read from the selected local Codex executable."),
        ...
        (Locale::Zh, "codex.runtime.subtitle") => Some("模型与能力直接读取自当前选择的本地 Codex 可执行程序。"),
