...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "files.remote_read_only") => Some("Remote browsing is read-only; file preview and download are not available yet."),
        ...
        (Locale::Zh, "files.remote_read_only") => Some("远程浏览目前为只读；文件预览和下载尚未开放。"),
